class Hangman	
	...
	#alternative to match letters, use word as first arg and guesses as an array, check each time looping thru word to check if there's a match and put match or leave
...
puts "line 106 #{good}"
	...
	# 		puts "word array is #{@word_array}, @guess is ==> #{@guess}, guess is ==> '#{guess}' Nope, guess again"
	# 	end
...
while !game.is_over?
	...
	puts "guess var #{game.guess}"

	#if good_guess? { show_match } else prompt_guess
